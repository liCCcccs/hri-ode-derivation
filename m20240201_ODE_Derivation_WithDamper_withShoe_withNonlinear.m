...
syms tau_intBz  % K_BMy*(r_q4 + r_q5 - h_q2) + K_BMyN3*(r_q4 + r_q5 - h_q2)^3 + D_BMy*(r_dq4 + r_dq5 - h_dq2)
...
syms f_intAi  % K_AFx * r_d3 + K_AFxN3 * r_d3^3 + D_AFx * r_dd3
syms f_intAj  % + K_AFz * r_d2 + K_AFzN3 * r_d2^3 + D_AFz * r_dd2
...
syms tau_intAz  % K_AMy*r_q4 + K_AMyN3*r_q4^3 + D_AMy*r_dq4
