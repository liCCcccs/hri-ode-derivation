...
vSym.lc1 = 0.173; vSym.la1 = 0.2; vSym.lb1 = 0.05; vSym.lc2 = 0.173; 
vSym.lc3 = 0.1; vSym.lc4 = 0.1; vSym.la4 = 0.2; vSym.la2 = 0.2; 
vSym.K_AFz = 6000; vSym.K_AFx = 3000; vSym.K_AMy = 50;
vSym.K_BFz = 6000; vSym.K_BFx = 3000; vSym.K_BMy = 50;

%% solve the dynamic equations
tspan = [0 1];
y0 = [0, 0, -0.5*pi, 0, 0, 0, 0, 0, 0, 0, -0.5*pi, 0];  %initial condition
tau = [0, 0, 0, 10];
